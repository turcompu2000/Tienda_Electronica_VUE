        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="input-group">
                        <div class="input-group-text"><font-awesome-icon icon="tag" /></div>
                        <input type="text" class="form-control" id="nombre_producto" placeholder="Codigo Producto"
                ...
                <div class="row mb-3">
                    <label for="precio" class="form-label">Codigo</label>
                    <div class="input-group">
                        <div class="input-group-text"><font-awesome-icon icon="tag" /></div>
...
export default {
    ...
    methods: {
        ...
        async updateProducto(){
            const res = await axios.put(`http://127.0.0.1:8000/api/productos/${this.producto.id_producto}`, this.producto)
            ...
            if(res.status == 200){
                ...
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    title: 'Producto has been updated',
    ...
    mounted(){
        this.producto.id_producto = this.$route.params.id;
        axios.get(`http://127.0.0.1:8000/api/productos/${this.producto.id_producto}`)
          .then(response => {
